...
const char* WINDOW_TITLE = "Cubemaps: reflection";
...
int main() {
  ...
  Shader shader(SHADERS_PATH "20_shader.vert", SHADERS_PATH "20_shader.frag");
  Shader skyboxShader(SHADERS_PATH "20_skybox_shader.vert", SHADERS_PATH "20_skybox_shader.frag");
  ...
  unsigned int cubemapTexture = loadCubemap(RESOURCES_PATH "textures/skybox/");
...
unsigned int loadCubemap(char const* path) {
  std::string faces[] = {
    std::string(path) + "right.jpg",
    std::string(path) + "left.jpg",
    std::string(path) + "top.jpg",
    std::string(path) + "bottom.jpg",
    std::string(path) + "front.jpg",
    std::string(path) + "back.jpg"
  };

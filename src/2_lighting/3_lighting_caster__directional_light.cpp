...
const char* WINDOW_TITLE = "Lighting caster: directional light";
...
int main() {
  ...
  Shader shader(SHADERS_PATH "13_shader.vert", SHADERS_PATH "13_object_shader_directional_light.frag");
